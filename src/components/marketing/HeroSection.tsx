...
export default function HeroSection() {
  return (
    <section className="relative w-full bg-gradient-to-b from-[#c1cdd5] to-[#dce3e9]">
      ...
      {/* Top gradient fade */}
      <div
        className="absolute inset-x-0 top-0 h-32 bg-gradient-to-b from-[#DDE1E3] to-transparent z-[1]"
        aria-hidden="true"
      />
        ...
        <div className="max-w-[1400px] mx-auto mb-6 md:mb-8">
          <div className="flex flex-col md:flex-row md:items-start md:gap-16 lg:gap-24">
            ...
            <div className="shrink-0">
              <h1 className="text-[clamp(3rem,15vw,8rem)] font-normal leading-[0.9] tracking-tight text-foreground">
                Weavy
              </h1>
            </div>
        ...
        <div className="hidden md:block">
          <div className="relative mx-4 md:mx-8 lg:mx-16 p-0 rounded-b-[40px] overflow-visible bg-gradient-to-b from-[#dce3e9] to-[#c9d8cc] -mb-10">
            <div
              ...
              style={{
                background:
                  "radial-gradient(ellipse, hsla(0, 0%, 100%, 0.4) 0%, transparent 60%)",
              }}
              aria-hidden="true"
            />
